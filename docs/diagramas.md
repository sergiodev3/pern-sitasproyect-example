...
Mermaid no tiene un tipo de diagrama nativo para casos de uso UML; lo aproximamos con un flowchart que separa actores, un límite de sistema (`subgraph`) y las acciones disponibles para cada rol:
